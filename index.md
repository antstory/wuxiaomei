...
<body>
        ...
        <div id="pagepiling" style="overflow: hidden; touch-action: none;">
            <div class="section center pp-section pp-table pp-easing active" id="home" style="z-index: 7; transform: translate3d(0px, 0px, 0px);"><div class="pp-tableCell" style="height:100%">
                <img id="avatar" src="img/avatar.jpg">
                <h1 id="title">Wenli Zhang</h1>
                <p id="subtitle">A Passionate, Creative, and Devoted</p>
                <h4>Web Front-End Developer @Baidu</h4>

                <h6><a href="http://zhujianer.com" target="_blank">Zhujianer Design Studio</a></h6>
                <p><a href="mailto:me@zhangwenli.com">me@zhangwenli.com</a></p>
            </div></div>

            <div class="section pp-section pp-table pp-easing leaving" id="project" style="z-index: 6; transform: translate3d(0px, 0px, 0px);"><div class="pp-tableCell" style="height:100%">
                <h1>Projects</h1>
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <p>A <em>Web Audio</em> library designed for Web games, with both pure <em>JavaScript</em> version and <em>jQuery</em> version.</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <p><em>Introduction to Three.js</em> is an ebook written in Chinese to help beginners to start with Three.js, which is available on both <a href="http://www.ituring.com.cn/book/1272" target="_blank">iTuring</a> and <a href="http://read.douban.com/ebook/7412854/" target="_blank">Douban</a>.</p>
                    </div>
                    <div class="col-2 center">
                    ...
                    <div class="col-4">
                        <h2><a href="http://zhangwenli.com/blog/2014/09/01/handian-chrome-extension/" target="_blank">Chrome Extensions</a></h2>
                        <p><a href="http://zhangwenli.com/blog/2014/09/01/handian-chrome-extension/" target="_blank">Handian Immediate Translate Tool</a> and <a href="http://zhangwenli.com/blog/2014/09/01/readfree-chrome-extension/" target="_blank">ReadFree to Douban</a> are two useful Chrome Extensions for Chinese readers.</p>
                    </div>
                    <div class="clearboth"></div>
                </div>
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <p>A jQuery plugin to create a flat designed <em>paper folding effect</em> at the bottom-right corner.</p>
                    </div>
                    <div class="clearboth"></div>
                </div>
                <p class="center"><a href="http://github.com/Ovilia" target="_blank" class="highlight">And More on GitHub</a></p>
            </div></div>
            
            <div class="section center pp-section pp-table pp-easing leaving" id="profession" style="z-index: 5; transform: translate3d(0px, 0px, 0px);"><div class="pp-tableCell" style="height:100%">
                <h1>Professions</h1>
                <div class="tag-panel">
            ...
            <div class="section center pp-section pp-table pp-easing leaving" style="z-index: 4; transform: translate3d(0px, 0px, 0px);"><div class="pp-tableCell" style="height:100%">
                <h1>Education</h1>
            ...
            <div class="section center pp-section pp-table pp-easing leaving" style="z-index: 3; transform: translate3d(0px, 0px, 0px);"><div class="pp-tableCell" style="height:100%">
                <h1>Internship</h1>
            ...
            <div class="section center pp-section pp-table pp-easing leaving" style="z-index: 2; transform: translate3d(0px, 0px, 0px);"><div class="pp-tableCell" style="height:100%">
            ...
            <div class="section center pp-section pp-table pp-easing leaving" style="z-index: 1; transform: translate3d(0px, 0px, 0px);"><div class="pp-tableCell" style="height:100%">
                <h1>Learn More</h1>
                <h2><a href="http://zhangwenli.com/" target="_blank">Personal Website</a> | <a href="https://www.linkedin.com/in/wenlizhang" target="_blank">LinkedIn</a></h2>
...
<div id="pp-nav" class="left" style="margin-top: -73.5px;"><ul><li data-tooltip="Home"><a href="#" class="active"><span></span></a></li><li data-tooltip="Projects"><a href="#" class=""><span></span></a></li><li data-tooltip="Professions"><a href="#" class=""><span></span></a></li><li data-tooltip="Education"><a href="#" class=""><span></span></a></li><li data-tooltip="Internship"><a href="#" class=""><span></span></a></li><li data-tooltip="Current Position"><a href="#" class=""><span></span></a></li><li data-tooltip="Contact Me"><a href="#" class=""><span></span></a></li></ul></div></body>
<html>
